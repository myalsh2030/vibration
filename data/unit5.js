    ...
    // ════════════════════════════════════════════════════════════
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          icon: '⚙️',
          html: 'في <span class="term">الاتزان بمستويين <i>Two-Plane Balancing</i></span> تُقاس السعة والزاوية عند <b>محملين</b> لا محمل واحد، وتُوضع كتلة الاختبار في المستوى الأول مرة وفي الثاني مرة — أي <b>ثلاث دورات تشغيل</b> وست قراءات. عندها يعرف الجهاز أثر كل مستوى على كلا المحملين فيحسب كتلتَي التصحيح وزاويتيهما معًا. أنت تقيس وتُدخل وتفسّر؛ الحساب عمله هو.',
        },
        {
          t: 'tip',
